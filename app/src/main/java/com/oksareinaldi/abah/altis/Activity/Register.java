...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_register = (Button) findViewById(R.id.regBut);
        txt_username = (EditText) findViewById(R.id.regUs);
        txt_password = (EditText) findViewById(R.id.regPass);
        txt_email = (EditText) findViewById(R.id.regMail);
    ...
    private void checkRegister(final String username, final String password, final String email) {
